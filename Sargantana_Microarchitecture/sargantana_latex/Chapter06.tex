...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.35\textwidth]{ch06_decode_overview.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{ch06_decode_detail.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.75\textwidth]{ch06_decode_to_rename.png}
