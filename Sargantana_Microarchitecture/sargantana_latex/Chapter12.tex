...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{ch12_commit_overview.png}
...
Although the repository does not contain a standalone module named \rtlnolink{rob.sv}, the
...
\begin{rtlrefs}
  \rtlitem{rtl/control_unit/rtl/control_unit.sv}
  \rtlitem{rtl/datapath/rtl/wb_stage/rtl/graduation_list.sv}
  \rtlitemx{rtl/datapath/interface_csr/rtl/csr_interface.sv}{rtl/datapath/rtl/interface_csr/rtl/csr_interface.sv}
\end{rtlrefs}
